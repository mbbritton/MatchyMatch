...
export const COLOR_STYLES = {
  yellow: {
    bg:         "rgba(255,230,150,0.38)",
    border:     "rgba(212,168,67,0.40)",
    glow:       "rgba(212,168,67,0.14)",
    titleColor: "#7a5200",
    wordsColor: "#a06800",
    emoji:      "🌻",
  },
  green: {
    bg:         "rgba(180,230,190,0.38)",
    border:     "rgba(100,170,120,0.38)",
    glow:       "rgba(100,170,120,0.14)",
    titleColor: "#1a5c35",
    wordsColor: "#2d7a4a",
    emoji:      "🌿",
  },
  blue: {
    bg:         "rgba(190,215,255,0.38)",
    border:     "rgba(100,150,220,0.35)",
    glow:       "rgba(100,150,220,0.12)",
    titleColor: "#1a3a7a",
    wordsColor: "#2a52a8",
    emoji:      "💐",
  },
  purple: {
    bg:         "rgba(220,200,255,0.38)",
    border:     "rgba(155,126,200,0.40)",
  ...
  pink: {
    bg:         "rgba(255,200,215,0.40)",
    border:     "rgba(232,96,122,0.38)",
